...
> 🎓 A passionate **Data Scientist & ML enthusiast** who loves exploring the intersection of data, algorithms, and real-world impact.
>
> 🔭 I transform raw data into meaningful insights and build intelligent models that solve complex problems.
>
> 🌱 Currently deepening my knowledge in **Deep Learning & Computer Vision**.
>
> 💡 I believe that the best way to learn is by building — one project at a time!
...
```python
current_focus = {
    "📚 Topics"    : ["Advanced Deep Learning", "Computer Vision", "NLP & LLMs"],
    "🎯 Goal"      : "Build impactful AI-powered products",
    "⚡ Fun Fact"  : "I think in data frames 🧮"
}
```
...
| 🧠 More coming soon... | Stay tuned for exciting DS & ML projects | TensorFlow, PyTorch, OpenCV |
